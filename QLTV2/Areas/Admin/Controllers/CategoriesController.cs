...
namespace QLTV2.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,Title,Alias,CategoryName,Description,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsActive")] TbCategory tbCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,Title,Alias,CategoryName,Description,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsActive")] TbCategory tbCategory)
        {
